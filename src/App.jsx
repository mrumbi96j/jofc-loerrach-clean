...
Note: ${formData.notes}`
  ...
  const content = {
    it: {
      ...
      packages: [
        {
          title: "Soci",
          price: "Priorità club",
          items: ["Richiesta prioritaria", "Informazioni dirette", "Supporto del club"],
        },
        {
          title: "Non soci",
          price: "In base alla disponibilità",
      ...
      travelText: "Organizziamo viaggi, bus e supporto per vivere la Juventus insieme. Una sezione perfetta per pubblicare date, punti di ritrovo e informazioni utili per i tifosi.",
      membersTitle: "Area soci",
      membersText: "Qui si possono aggiungere iscrizioni, vantaggi membri, regolamento del club e priorità per i biglietti.",
      contactBoxTitle: "Informazioni ufficiali",
      footer: "Juventus Official Fan Club Lörrach G. Agnelli • Sito demo professionale del fan club",
    },
  };
